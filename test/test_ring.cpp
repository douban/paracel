...
BOOST_AUTO_TEST_CASE (ring_test) {
  {
    ...
    std::string key("dw");
    PARACEL_CHECK_EQUAL(2, ring.get_server(key));
    ...
    PARACEL_CHECK_EQUAL(1, ring.get_server(key4));
    std::string key5("q[,:3]_0");
    PARACEL_CHECK_EQUAL(3, ring.get_server(key5));
    ...
    PARACEL_CHECK_EQUAL(3, ring.get_server(key8));
    std::string key9("p[5:,]_2");
    PARACEL_CHECK_EQUAL(2, ring.get_server(key9));
    std::string key10("p[3:,]_1");
    PARACEL_CHECK_EQUAL(3, ring.get_server(key10));
    // char* is unhashable
  ...
  }
  {
    ...
    std::string key("dw");
    PARACEL_CHECK_EQUAL("beater7", ring.get_server(key));
    std::string key2("q[,:0]_0");
    PARACEL_CHECK_EQUAL("beater5", ring.get_server(key2));
    std::string key3("q[,:1]_0");
    PARACEL_CHECK_EQUAL("balin1", ring.get_server(key3));
    std::string key4("q[,:2]_0");
    PARACEL_CHECK_EQUAL("beater7", ring.get_server(key4));
    std::string key5("q[,:3]_0");
    PARACEL_CHECK_EQUAL("beater7", ring.get_server(key5));
    std::string key6("p[0:,]_2");
    PARACEL_CHECK_EQUAL("balin1", ring.get_server(key6));
    std::string key7("p[13:,]_2");
    PARACEL_CHECK_EQUAL("beater7", ring.get_server(key7));
    std::string key8("p[42:,]_2");
    PARACEL_CHECK_EQUAL("balin1", ring.get_server(key8));
    std::string key9("p[5:,]_2");
    PARACEL_CHECK_EQUAL("beater5", ring.get_server(key9));
    std::string key10("p[3:,]_1");
